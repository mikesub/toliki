...
export STUB_SESSIONS="testrepo-look-at-the-logs" STUB_MANUAL_SESSIONS="testrepo-look-at-the-logs" STUB_PANE_CMD=claude
run_launch --check-capacity
...
unset STUB_SESSIONS STUB_MANUAL_SESSIONS STUB_PANE_CMD
